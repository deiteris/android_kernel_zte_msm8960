...
static struct l2_level l2_freq_tbl_8960_kraitv2[] = {
	[0]  = { {STBY_KHZ, QSB,   0, 0, 0x00 }, 950000, 950000, 0 },
	[1]  = { {  384000, PLL_8, 0, 2, 0x00 }, 950000, 950000, 1 },
	[2]  = { {  432000, HFPLL, 2, 0, 0x20 }, 950000, 950000, 2 },
	[3]  = { {  486000, HFPLL, 2, 0, 0x24 }, 950000, 950000, 2 },
	[4]  = { {  540000, HFPLL, 2, 0, 0x28 }, 950000, 950000, 2 },
	[5]  = { {  594000, HFPLL, 1, 0, 0x16 }, 950000, 950000, 2 },
	[6]  = { {  648000, HFPLL, 1, 0, 0x18 }, 950000, 950000, 4 },
	[7]  = { {  702000, HFPLL, 1, 0, 0x1A }, 950000, 950000, 4 },
	[8]  = { {  756000, HFPLL, 1, 0, 0x1C }, 950000, 950000, 4 },
	[9]  = { {  810000, HFPLL, 1, 0, 0x1E }, 1050000, 1050000, 4 },
	[10] = { {  864000, HFPLL, 1, 0, 0x20 }, 1050000, 1050000, 4 },
	[11] = { {  918000, HFPLL, 1, 0, 0x22 }, 1050000, 1050000, 6 },
	[12] = { {  972000, HFPLL, 1, 0, 0x24 }, 1050000, 1050000, 6 },
	[13] = { { 1026000, HFPLL, 1, 0, 0x26 }, 1050000, 1050000, 6 },
	[14] = { { 1080000, HFPLL, 1, 0, 0x28 }, 1050000, 1050000, 6 },
	[15] = { { 1134000, HFPLL, 1, 0, 0x2A }, 1050000, 1050000, 6 },
	[16] = { { 1188000, HFPLL, 1, 0, 0x2C }, 1050000, 1050000, 6 },
...
struct acpu_level acpu_freq_tbl_8960_kraitv2_slow[] = {
        { 1, {   192000, HFPLL, 2, 0, 0x10 }, L2(1),   900000 },
        { 1, {   240000, HFPLL, 2, 0, 0x12 }, L2(1),   900000 },
        { 0, {   288000, HFPLL, 2, 0, 0x14 }, L2(1),   900000 },
        { 1, {   336000, HFPLL, 2, 0, 0x16 }, L2(1),   900000 },
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   900000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   925000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(3),   975000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(4),   975000 },
	...
	{ 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(12), 1100000 },
	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(14), 1100000 },
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(16), 1125000 },
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(18), 1125000 },
	...
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(19), 1250000 },
	{ 1, {  1512000, HFPLL, 1, 0, 0x38 }, L2(19), 1275000 },
	{ 0, { 0 } }
};

struct acpu_level acpu_freq_tbl_8960_kraitv2_nom[] = {
        { 1, {   192000, HFPLL, 2, 0, 0x10 }, L2(1),   825000 },
        { 1, {   240000, HFPLL, 2, 0, 0x12 }, L2(1),   825000 },
        { 0, {   288000, HFPLL, 2, 0, 0x14 }, L2(1),   825000 },
        { 1, {   336000, HFPLL, 2, 0, 0x16 }, L2(1),   825000 },
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   850000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   875000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(3),   925000 },
	...
	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(10), 1025000 },
	{ 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(12), 1050000 },
	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(14), 1050000 },
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(16), 1075000 },
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(18), 1075000 },
...
struct acpu_level acpu_freq_tbl_8960_kraitv2_fast[] = {
        { 1, {   192000, HFPLL, 2, 0, 0x10 }, L2(1),   800000 },
        { 1, {   240000, HFPLL, 2, 0, 0x12 }, L2(1),   800000 },
        { 0, {   288000, HFPLL, 2, 0, 0x14 }, L2(1),   800000 },
        { 1, {   336000, HFPLL, 2, 0, 0x16 }, L2(1),   800000 },
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   825000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   825000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(3),   875000 },
	...
	{ 1, {   810000, HFPLL, 1, 0, 0x1E }, L2(10),  975000 },
	{ 0, {   864000, HFPLL, 1, 0, 0x20 }, L2(12), 1000000 },
	{ 1, {   918000, HFPLL, 1, 0, 0x22 }, L2(14), 1000000 },
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(16), 1025000 },
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(18), 1025000 },
	...
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(19), 1150000 },
